...
class SM_XReport_Block_Adminhtml_XReportbackend extends Mage_Adminhtml_Block_Template {
    ...
    public function getDataStock() {
        ...
        $querry = 'SELECT SUM(`stock_status`) AS `in_stock`, COUNT(`stock_status`) AS `all_stock` 
        FROM ' . Mage::getSingleton('core/resource')->getTableName('cataloginventory_stock_status') ;
