...
class Ultimo_Authorize_Block_Authorizenet_Form_Cc extends Mage_Payment_Block_Form
{
    /**
     * Set block template
     */
    ...
    {
        return $this->getLayout()->createBlock('ultimoauthorize/authorizenet_info_cc')
            ->setMethod($this->getMethod())
    ...
    {
        return $this->getUrl('ultimoauthorize/authorizenet_payment/cancel');
    }
